...
<head>
    ...
    @php
        $faviconSetting = \App\Models\PageSetting::where('key', 'favicon')->first();
        $faviconUrl = $faviconSetting && $faviconSetting->value ? storage_url($faviconSetting->value) : asset('favicon.ico');
    @endphp
