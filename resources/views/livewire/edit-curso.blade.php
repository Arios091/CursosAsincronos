    ...
    <div class="container py-4">
        <div class="card shadow">
            <div class="card-header text-white font-weight-bold d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, #0B5E2E, #0A4A24);">
                <span><i class="fas fa-edit mr-1"></i> Editar Curso: {{ $titulo }}</span>
            ...
            <div class="card-body">
                                ...
                                <div class="border rounded p-2 mb-2 bg-white">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            @else
                                            <input type="file" class="form-control-file form-control-sm" wire:model="modulos.{{ $modIdx }}.materiales.{{ $matIdx }}.archivo_nuevo" accept=".pdf">
                                            @if($material['archivo'])
                                            <small class="text-muted d-block mt-1">Archivo actual: {{ basename($material['archivo']) }}</small>
                                            @endif
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        @if(!empty($pregunta['tiene_justificacion']))
                                            ...
                                            <textarea class="form-control form-control-sm"
                                                      ...
                                                      rows="2"
                                                      placeholder="Explica por que la opcion correcta es la correcta..."></textarea>
                                        @else
                ...
                <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                    ...
                    @else
                    <button class="btn text-white font-weight-bold px-4" style="background: #C9A227;" wire:click="actualizarCurso">
                        <i class="fas fa-save mr-1"></i> Actualizar Curso
                    </button>
                    @endif
                </div>
            </div>
